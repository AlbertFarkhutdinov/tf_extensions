...
COMBINATIONS = (
    [cl.CustomLoss(), cl.VGGLoss()],
    [cl.CustomLoss(), cl.FFTLoss()],
    [cl.CustomLoss(), cl.FFTLoss(), cl.FFTLoss()],
    [cl.CustomLoss(), cl.FFTLoss(), cl.SoftDiceLoss()],
)
...
class TestCombinedLoss:
    ...
    def test_combined_loss_with_different_lengths(self) -> None:
        with pytest.raises(
            ...
            cl.CombinedLoss(losses=[cl.CustomLoss()], weights=[1, 1, 1])
